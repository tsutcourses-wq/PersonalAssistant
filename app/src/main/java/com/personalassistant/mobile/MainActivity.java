...
public class MainActivity extends Activity {
    ...
    private static final String APP_VERSION = "3.7.5 Android";
    ...
    private Button btn(String text) {
        ...
        button.setBackground(rounded(primaryColor, 12));
    ...
    private Button outlineBtn(String text) {
        ...
        button.setAllCaps(false);
        button.setTextSize(14);
        button.setBackground(rounded(panel2Color, 12));
        button.setMinHeight(dp(44));
        button.setPadding(dp(12), dp(6), dp(12), dp(6));
        return button;
    }
    ...
    private LinearLayout card() {
        ...
        card.setBackground(rounded(panelColor, 16));
    ...
    private void setScreen(String title, LinearLayout content) {
        ...
        menu.setBackground(rounded(primaryColor, 8));
        ...
        titleBox.addView(tv(title, 20, 0xFFFFFFFF, Typeface.BOLD));
    ...
    private LinearLayout buildWeekCalendar() {
        ...
        card.addView(tv("Shamsi calendar • this week", 18, textColor, Typeface.BOLD));
    ...
    private void showSettings() {
        ...
        addButton(database, outlineBtn("Export student list for Excel (CSV)"), v -> pickExportStudentsCsv());
        ...
        try {
            if (!cursor.moveToFirst()) {
                ...
                do {
                    ...
                    addButton(item, outlineBtn("Edit"), v -> editReminder(id));
    ...
    private void editReminder(long id) {
        ...
        addButton(form, outlineBtn("Back"), v -> showReminders());
    ...
    private void editStudent(long id, String requestedLevel) {
        ...
        addButton(form, outlineBtn("Back"), v -> showStudents());
        content.addView(form);
    ...
    private void editProject(long id) {
        ...
        addButton(form, outlineBtn("Back"), v -> showProjects());
        content.addView(form);
    ...
    private void editProjectStaff(long projectId, long staffId) {
        ...
        addButton(form, outlineBtn("Back"), v -> showProjectStaff(projectId));
        content.addView(form);
    ...
    private void editWbs(long projectId, long itemId) {
        ...
        addButton(form, outlineBtn("Back"), v -> showWbs(projectId));
        content.addView(form);
    ...
    private void editCbs(long projectId, long itemId) {
        ...
        addButton(form, outlineBtn("Back"), v -> showCbs(projectId));
        content.addView(form);
    ...
    private void editSCurvePoint(long projectId, long pointId) {
        ...
        addButton(form, outlineBtn("Back"), v -> showSCurve(projectId));
        content.addView(form);
    ...
    private void editGantt(long projectId, long taskId) {
        ...
        addButton(form, outlineBtn("Back"), v -> showGantt(projectId));
        content.addView(form);
    ...
    private void editCourse(long id) {
        ...
        addButton(form, outlineBtn("Back"), v -> showCourses());
        content.addView(form);
    ...
    private void showCourseFiles(long courseId) {
        ...
        addButton(top, outlineBtn("Back to course"), v -> editCourse(courseId));
        content.addView(top);
