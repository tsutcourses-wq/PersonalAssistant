...
public class MainActivity extends Activity {
    ...
    private void showDashboard() {
        ...
        notes.addView(tv("Save notes in English, فارسی, or both.", 12, mutedColor, Typeface.NORMAL));
    ...
    private LinearLayout buildDashboardCalendar() {
        ...
        addEqualRowButton(nav, outlineBtn("Today"), v -> resetDashboardCalendarToToday());
    ...
    private void addDashboardWeekView(LinearLayout box) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            LinearLayout dayCard = buildDashboardDayCard(date, names[i], String.format(Locale.US, "%02d/%02d", j[1], j[2]));
