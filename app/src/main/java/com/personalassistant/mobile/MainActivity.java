...
public class MainActivity extends Activity {
    ...
    private void addDashboardWeekView(LinearLayout box) {
        ...
        // Show the complete week at once. Navigation to other weeks is handled
        // by Previous / Next, so the user no longer has to horizontally scroll
        // inside a single week just to reach the last days.
